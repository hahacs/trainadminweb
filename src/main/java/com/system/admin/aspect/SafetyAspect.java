package com.system.admin.aspect;
...
import com.system.admin.util.AesUtil;
import com.system.admin.util.ErrorUtil;
import com.system.admin.util.RsaUtil;
...
public class SafetyAspect {
     ...
     * Pointcut 切入点
     * 匹配
     * com.system.admin.sys.*.controller、
     * com.system.admin.*.controller包下面的所有方法
     */
    @Pointcut(value = "execution(public * com.system.admin.sys.*.controller.*.*(..)) || " +
            "execution(public * com.system.admin.*.controller.*.*(..))")
